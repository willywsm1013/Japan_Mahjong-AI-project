...
def getScore( winAgent, winCards, hiddenCards , openedCards , agentWind = None , winTime = None ):    
    ...
    winCard =[] #no combination , easy for calculation
    verbose=True
    ...
    if verbose:
        ...
        print ( "Among them, hidden is ",hiddenCards , "; Opened is ,",openedCards)
        print ("----------------------------------------")    
